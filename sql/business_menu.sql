...
-- 二级目录：数据接入与解析（Excel解析、PDF解析和文本结构化）
insert into sys_menu values('2100', '数据接入与解析', '2000', '1', 'data', null, '', '', 1, 0, 'M', '0', '0', '', 'data', 'admin', sysdate(), '', null, 'Excel/PDF/文本解析目录');
-- 二级目录：市场分析（整车市场分析）
...
-- 二级菜单：AI配置（统一大模型凭证）
insert into sys_menu values('2600', 'AI配置', '2000', '6', 'ai', 'business/ai/index', '', 'AiConfig', 1, 0, 'C', '0', '0', 'business:ai:config:query', 'edit', 'admin', sysdate(), '', null, '系统统一大模型凭证与作用范围');
...
-- Excel、PDF和文本结构化在数据接入与解析目录
insert into sys_menu values('2101', 'Excel解析', '2100', '1', 'excel', 'business/data/excel/index', '', '', 1, 0, 'C', '0', '0', 'business:data:excel:list', 'excel', 'admin', sysdate(), '', null, 'Excel/CSV 解析、字段识别、预览和质量检查');
...
insert into sys_menu values('2303', '懂车帝车辆采集', '2300', '2', 'vehicle', 'business/vehicle/index', '', '', 1, 0, 'C', '0', '0', 'business:vehicle:collect:list', 'car', 'admin', sysdate(), '', null, '懂车帝车型参数采集（入库统一知识库）');
...
-- 按钮权限：Excel解析
insert into sys_menu values('2110', 'Excel解析查询', '2101', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'business:data:excel:query', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2111', 'Excel解析新增', '2101', '2', '', '', '', '', 1, 0, 'F', '0', '0', 'business:data:excel:add', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2112', 'Excel解析修改', '2101', '3', '', '', '', '', 1, 0, 'F', '0', '0', 'business:data:excel:edit', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2113', 'Excel解析删除', '2101', '4', '', '', '', '', 1, 0, 'F', '0', '0', 'business:data:excel:remove', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2114', 'Excel解析导出', '2101', '5', '', '', '', '', 1, 0, 'F', '0', '0', 'business:data:excel:export', '#', 'admin', sysdate(), '', null, '');

-- 按钮权限：车载市场分析（复用现有 Excel/报告接口权限字）
...
-- 按钮权限：懂车帝车辆采集
insert into sys_menu values('2330', '车辆采集查询', '2303', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:collect:query', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2331', '车辆采集新增', '2303', '2', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:collect:add', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2332', '车辆采集修改', '2303', '3', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:collect:edit', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2333', '车辆采集删除', '2303', '4', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:collect:remove', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2334', '车辆采集导出', '2303', '5', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:collect:export', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2335', '车型数据列表', '2303', '6', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:model:list', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2336', '车型数据查询', '2303', '7', '', '', '', '', 1, 0, 'F', '0', '0', 'business:vehicle:model:query', '#', 'admin', sysdate(), '', null, '');
...
-- 按钮权限：AI配置
insert into sys_menu values('2610', 'AI配置查询', '2600', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'business:ai:config:query', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2611', 'AI配置修改', '2600', '2', '', '', '', '', 1, 0, 'F', '0', '0', 'business:ai:config:edit', '#', 'admin', sysdate(), '', null, '');
